...
import { femaleAdmissionTextTiming, femaleChoiceTextData, maleAdmissionTextTiming, maleChoiceTextData, nonBinaryAdmissionTextTiming, nonBinaryChoiceTextData } from '../data/timingData'
...
const id=7;
  ...
  if(voicePref==="female"){
     dialogue=femaleAudio[id].audio;
     choiceData=femaleAdmissionTextTiming;
  }else if(voicePref==="male"){
     dialogue=maleAudio[id].audio;
     choiceData=maleAdmissionTextTiming;
  }else{
     dialogue=nonBinaryAudio[id].audio;
     choiceData=nonBinaryAdmissionTextTiming;
  }
...
const AdmissionTextOnly = () => {
  ...
  function helper(): void {
    ...
    setTemp((temp)=>[...temp, scriptAdmission[currentScriptIndex]]);
    if(temp.length>4){
    temp.shift();
    }
    setTimeout(() => {

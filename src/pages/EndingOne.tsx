...
import { femaleEndingOneTextTiming, maleEndingOneTextTiming, nonBinaryEndingOneTextTiming } from '../data/tempnonbinary'
...
const id=8;
  ...
  if(voicePref==="female"){
     ...
     choiceData=femaleEndingOneTextTiming;
  }else if(voicePref==="male"){
     dialogue=maleAudio[id].audio;
     choiceData=maleEndingOneTextTiming;
  }else{
     dialogue=nonBinaryAudio[id].audio;
     choiceData=nonBinaryEndingOneTextTiming;
  }
...
const EndingOneTextOnly = () => {
  ...
  function helper(): void {
    ...
    setTemp((temp)=>[...temp, scriptEndingOne[currentScriptIndex]]);
    if(temp.length>4){
    temp.shift();
    }
    setTimeout(() => {

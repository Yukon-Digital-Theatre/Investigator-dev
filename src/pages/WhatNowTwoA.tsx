...
useEffect(() => {
  ...
  return (
    <div>
    {narratorTextMode&&<><p className='introText outlineText'> You made your choices and ultimately you chose to let this Weaver go, but arrest others.</p><p className='introText outlineText'> Now that you’ve made your choice, your time being the investigator in this world is coming to an end. However, this world continues, time moves on, and they must live with your choice. </p></>}
